...
GNzbGuiState::GNzbGuiState()
{
}

GNzbGuiState::GNzbGuiState(GNzbGuiState&& that)
:   m_ref_files_model(std::move(that.m_ref_files_model)),
	m_value_v(that.m_value_v),
	m_value_h(that.m_value_h),
	m_top_row_path(std::move(that.m_top_row_path))
{
}

GNzbGuiState::GNzbGuiState(const GNzbGuiState& that)
:   m_ref_files_model(that.m_ref_files_model),
	m_value_v(that.m_value_v),
	m_value_h(that.m_value_h),
	m_top_row_path(that.m_top_row_path)
{
}
...
GNzbGuiState& GNzbGuiState::files_model(const Glib::RefPtr<Gtk::TreeModel>& model)
{
	m_ref_files_model = model;
	return *this;
}

GNzbGuiState& GNzbGuiState::files_model(Glib::RefPtr<Gtk::TreeModel>&& model)
{
	m_ref_files_model = std::move(model);
	return *this;
}

GNzbGuiState& GNzbGuiState::top_row_path(const std::string& path)
{
	m_top_row_path = path;
	return *this;
}

GNzbGuiState& GNzbGuiState::top_row_path(std::string&& path)
{
	m_top_row_path = std::move(path);
	return *this;
}

GNzbGuiState& GNzbGuiState::operator =(GNzbGuiState&& that)
{
	m_ref_files_model = std::move(that.m_ref_files_model);
	m_value_v = that.m_value_v;
	m_value_h = that.m_value_h;
...
GNzbGuiState& GNzbGuiState::operator =(const GNzbGuiState& that)
{
	m_ref_files_model = that.m_ref_files_model;
	m_value_v = that.m_value_v;
	m_value_h = that.m_value_h;
